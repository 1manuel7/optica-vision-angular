...
@Component({
  ...
  standalone: true,
  // Agregamos RouterModule para que funcionen los enlaces si se necesitan
  imports: [
...
export class PacienteDetalleComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if (pacienteEncontrado) {
      ...
      this.cargando = false;
      // Obligamos a Angular a pintar los datos inmediatamente
  ...
  cargarHistorial() {
    // Escuchamos las órdenes relacionales y las filtramos y ordenamos cronológicamente
  ...
  imprimirReceta() {
    ...
    doc.text('OBTICA VISIÓN', 105, 20, { align: 'center' });
